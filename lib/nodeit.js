...
function Nodeit (opts) {
  this.opts = opts || {}
  this.bridge = opts.bridge || bridge
 ...
 * @param {Function} cb Callback
 */
Nodeit.prototype.save = function (cb) {
...
Nodeit.prototype.close  = function (doc, cb) {
  ...
  this.bridge.close(doc.nodeit.path, doc.getValue(), function (er) {
    ...
    chromeTabs.closeTab(this.tabsEl, this.findTabByDoc(doc))
...
Nodeit.prototype.onTabChange = function () {
  ...
  // Deal with fallout from closed doc
  if (closedDoc) {
    this.close(closedDoc)
  }
