...
function FontSizePlugin (nodeit) {
  ...
  var input = nodeit.getEditor().getInputField()
  
  // Note: "meta" == cmd
  $(input).bind("keydown.meta_0 keydown.ctrl_0", this.onCmd0.bind(this))
  
  // You can't bind to all the keys!
  // Webkit is no bind "=" and "-"
  // Firefox is no bind "-"
  // Maybe in the future?
  $(input).bind("keydown.meta_= keydown.ctrl_=", this.onCmdEqual.bind(this))
  $(input).bind("keydown.meta_- keydown.ctrl_-", this.onCmdMinus.bind(this))
 ...
 * @private
 */
FontSizePlugin.prototype.onCmd0 = function (e) {
  e.preventDefault()
  this.reset()
}
 ...
 * @private
 */
FontSizePlugin.prototype.onCmdMinus = function (e) {
  e.preventDefault()
  this.decrease()
}
 ...
 * @private
 */
FontSizePlugin.prototype.onCmdEqual = function (e) {
  e.preventDefault()
  this.increase()
}
